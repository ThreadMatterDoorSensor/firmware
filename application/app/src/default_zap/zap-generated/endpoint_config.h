	...
	{                                                                                    \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000007, 4, ZAP_TYPE(INT32S),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(READABLE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 NULLABLE)}, /* LastConnectErrorValue */                     \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000003, 4, ZAP_TYPE(INT32U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* TotalOperationalHours */                     \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000008, 1, ZAP_TYPE(BOOLEAN),                      \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* TestEventTriggersEnabled */                  \
		{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                     \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                     \
		{ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                       \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000012, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* AttachAttemptCount */                        \
		{ZAP_EMPTY_DEFAULT(), 0x00000013, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* PartitionIdChangeCount */                    \
		{ZAP_EMPTY_DEFAULT(), 0x00000014, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* BetterPartitionAttachAttemptCount \
							 */                                  \
		{ZAP_EMPTY_DEFAULT(), 0x00000015, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* ParentChangeCount */                         \
		...
		{ZAP_EMPTY_DEFAULT(), 0x0000001B, 4, ZAP_TYPE(INT32U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* TxNoAckRequestedCount */                     \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000022, 4, ZAP_TYPE(INT32U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* TxDirectMaxRetryExpiryCount */               \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000026, 4, ZAP_TYPE(INT32U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* TxErrBusyChannelCount */                     \
		...
		{ZAP_EMPTY_DEFAULT(), 0x0000003E, 0, ZAP_TYPE(ARRAY),                        \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* ActiveNetworkFaultsList */                   \
		{ZAP_SIMPLE_DEFAULT(0x000F), 0x0000FFFC, 4,                                  \
		 ZAP_TYPE(BITMAP32),                                                         \
		 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                             \
		{ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* MaxGroupsPerFabric */                        \
		{ZAP_EMPTY_DEFAULT(), 0x00000003, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* MaxGroupKeysPerFabric */                     \
		{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                     \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                     \
		{ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                       \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000001, 4, ZAP_TYPE(INT32U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* ActiveModeDuration */                        \
		{ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* ActiveModeThreshold */                       \
		{ZAP_EMPTY_DEFAULT(), 0x00000003, 0, ZAP_TYPE(ARRAY),                        \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* RegisteredClients */                         \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000005, 2, ZAP_TYPE(INT16U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* ClientsSupportedPerFabric */                 \
		{ZAP_SIMPLE_DEFAULT(0x10000), 0x00000006, 4,                                 \
		 ZAP_TYPE(BITMAP32),                                                         \
		 ZAP_ATTRIBUTE_MASK(                                                         \
			 READABLE)}, /* UserActiveModeTriggerHint */                         \
		{ZAP_LONG_DEFAULTS_INDEX(0), 0x00000007, 129,                                \
		 ZAP_TYPE(CHAR_STRING),                                                      \
		 ZAP_ATTRIBUTE_MASK(                                                         \
			 READABLE)}, /* UserActiveModeTriggerInstruction */                  \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000009, 4, ZAP_TYPE(INT32U),                       \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(                                                 \
				 READABLE)}, /* MaximumCheckInBackOff */                     \
		{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                     \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                      \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                     \
