...
#define GENERATED_DEFAULTS                                                     \
	{                                                                      \
		...
		43,  'P', 'r', 'e', 's', 's', ' ', 't', 'h', 'e', ' ', 'b',    \
		'u', 't', 't', 'o', 'n', ' ', 's', 'p', 'e', 'c', 'i', 'f',    \
		'i', 'e', 'd', ' ', 'i', 'n', ' ', 'd', 'o', 'c', 'u', 'm',    \
		'e', 'n', 't', 'a', 't', 'i', 'o', 'n', /* 44 - Description    \
							   (Power Source), */  \
		7,   'B', 'a', 't', 't', 'e', 'r', 'y',                        \
	}
		 ...
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                  \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000003, 0, ZAP_TYPE(ARRAY),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* PartsList */                     \
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4,                             \
			 ZAP_TYPE(BITMAP32),                                             \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* FeatureMap */                    \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000002, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SubjectsPerAccessControlEntry    \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000003, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* TargetsPerAccessControlEntry     \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000004, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* AccessControlEntriesPerFabric    \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4,                             \
			 ZAP_TYPE(BITMAP32),                                             \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000000, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* DataModelRevision                \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000001, 33,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* VendorName */                    \
			{ZAP_EMPTY_DEFAULT(), 0x00000002, 2,                             \
			 ZAP_TYPE(VENDOR_ID),                                            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(READABLE)}, /* VendorID */           \
			{ZAP_EMPTY_DEFAULT(), 0x00000003, 33,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ProductName */                   \
			{ZAP_EMPTY_DEFAULT(), 0x00000004, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ProductID */                     \
			{ZAP_EMPTY_DEFAULT(), 0x00000005, 33,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(WRITABLE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* NodeLabel */                     \
			{ZAP_EMPTY_DEFAULT(), 0x00000006, 3,                             \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(WRITABLE) |                          \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000007, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* HardwareVersion */               \
			{ZAP_EMPTY_DEFAULT(), 0x00000008, 65,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* HardwareVersionString            \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000009, 4, ZAP_TYPE(INT32U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SoftwareVersion */               \
			{ZAP_EMPTY_DEFAULT(), 0x0000000A, 65,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SoftwareVersionString            \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x0000000B, 17,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ManufacturingDate                \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x0000000F, 33,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SerialNumber */                  \
			{ZAP_EMPTY_DEFAULT(), 0x00000012, 33,                            \
			 ZAP_TYPE(CHAR_STRING),                                          \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
			...
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ClusterRevision */               \
                                                                                         \
			/* Endpoint: 0, Cluster: OTA Software Update Requestor           \
			   (server) */                                                   \
			{ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(WRITABLE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* DefaultOTAProviders */           \
			{ZAP_SIMPLE_DEFAULT(1), 0x00000001, 1,                           \
			 ZAP_TYPE(BOOLEAN),                                              \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* UpdatePossible */             \
			{ZAP_SIMPLE_DEFAULT(0), 0x00000002, 1,                           \
			 ZAP_TYPE(ENUM8),                                                \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000003, 1, ZAP_TYPE(INT8U),            \
			 ZAP_ATTRIBUTE_MASK(READABLE) |                                  \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 NULLABLE)}, /* UpdateStateProgress */           \
			{ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4,                           \
			 ZAP_TYPE(BITMAP32),                                             \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                 \
			{ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2,                           \
			 ZAP_TYPE(INT16U),                                               \
			 ZAP_ATTRIBUTE_MASK(READABLE)}, /* ClusterRevision */            \
                                                                                         \
			/* Endpoint: 0, Cluster: General Commissioning                   \
			   (server) */                                                   \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000001, 0, ZAP_TYPE(STRUCT),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* BasicCommissioningInfo           \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000002, 1, ZAP_TYPE(ENUM8),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* RegulatoryConfig                 \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000003, 1, ZAP_TYPE(ENUM8),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* LocationCapability               \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000004, 1,                             \
			 ZAP_TYPE(BOOLEAN),                                              \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SupportsConcurrentConnection     \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4,                             \
			 ZAP_TYPE(BITMAP32),                                             \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
			...
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFD, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ClusterRevision */               \
                                                                                         \
			/* Endpoint: 0, Cluster: Network Commissioning                   \
			   (server) */                                                   \
			{ZAP_EMPTY_DEFAULT(), 0x00000000, 1, ZAP_TYPE(INT8U),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* MaxNetworks */                   \
			{ZAP_EMPTY_DEFAULT(), 0x00000001, 0, ZAP_TYPE(ARRAY),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000002, 1, ZAP_TYPE(INT8U),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ScanMaxTimeSeconds               \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000003, 1, ZAP_TYPE(INT8U),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ConnectMaxTimeSeconds            \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000004, 1,                             \
			 ZAP_TYPE(BOOLEAN),                                              \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(WRITABLE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* InterfaceEnabled */              \
			{ZAP_EMPTY_DEFAULT(), 0x00000005, 1, ZAP_TYPE(ENUM8),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(READABLE) |                          \
				 ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* LastNetworkingStatus  \
								 */                      \
			{ZAP_EMPTY_DEFAULT(), 0x00000006, 33,                            \
			 ZAP_TYPE(OCTET_STRING),                                         \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(READABLE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 NULLABLE)}, /* LastNetworkID */                 \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000008, 0, ZAP_TYPE(ARRAY),            \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SupportedWiFiBands               \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x00000009, 2,                             \
			 ZAP_TYPE(BITMAP16),                                             \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* SupportedThreadFeatures          \
						      */                                 \
			{ZAP_EMPTY_DEFAULT(), 0x0000000A, 2, ZAP_TYPE(INT16U),           \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
					 READABLE)}, /* ThreadVersion */                 \
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4,                             \
			 ZAP_TYPE(BITMAP32),                                             \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                          \
				 ZAP_ATTRIBUTE_MASK(                                     \
...
{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),
 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |
	...
	{ZAP_EMPTY_DEFAULT(), 0x00000023, 4, ZAP_TYPE(INT32U),
	 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |
		 ZAP_ATTRIBUTE_MASK(
			 READABLE)}, /* TxIndirectMaxRetryExpiryCount     \
				      */
	...
	{ZAP_EMPTY_DEFAULT(), 0x0000003D, 0, ZAP_TYPE(STRUCT),
	 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(READABLE) |
		 ZAP_ATTRIBUTE_MASK(
			 NULLABLE)}, /* OperationalDatasetComponents */
	...
	{ZAP_LONG_DEFAULTS_INDEX(44), 0x00000002, 65, ZAP_TYPE(CHAR_STRING),
	 ZAP_ATTRIBUTE_MASK(READABLE)}, /* Description */
	{ZAP_EMPTY_DEFAULT(), 0x0000000B, 4, ZAP_TYPE(INT32U),
	 ZAP_ATTRIBUTE_MASK(READABLE) |
		 ZAP_ATTRIBUTE_MASK(NULLABLE)}, /* BatVoltage */
	...
	{ZAP_SIMPLE_DEFAULT(2), 0x00000010, 1, ZAP_TYPE(ENUM8),
