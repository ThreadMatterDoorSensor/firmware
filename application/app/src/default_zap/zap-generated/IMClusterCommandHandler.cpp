		      ...
		      TLV::TLVReader &aDataTlv)
{
	...
	bool wasHandled = false;
	{
		...
		case Commands::RegisterClient::Id: {
			...
			TLVError = commandData.Decode(
				aDataTlv,
				apCommandObj->GetAccessingFabricIndex());
			if (TLVError == CHIP_NO_ERROR) {
				wasHandled =
					emberAfIcdManagementClusterRegisterClientCallback(
						apCommandObj, aCommandPath,
						commandData);
			}
			break;
		}
	...
	if (CHIP_NO_ERROR != TLVError || !wasHandled) {
		ChipLogProgress(Zcl,
				...
				"TLVError=%" CHIP_ERROR_FORMAT,
				TLVError.Format());
		return Protocols::InteractionModel::Status::InvalidCommand;
	}

	// We use success as a marker that no special handling is required
	// This is to avoid having a std::optional which uses slightly more
	// code.
		      ...
		      TLV::TLVReader &aDataTlv)
{
	...
	bool wasHandled = false;
	{
		...
		case Commands::AnnounceOTAProvider::Id: {
			Commands::AnnounceOTAProvider::DecodableType
				commandData;
			TLVError = DataModel::Decode(aDataTlv, commandData);
			if (TLVError == CHIP_NO_ERROR) {
				wasHandled =
				  ...
				  CommandHandler *apCommandObj)
{
	...
	case Clusters::IcdManagement::Id:
		errorStatus = Clusters::IcdManagement::DispatchServerCommand(
			apCommandObj, aCommandPath, aReader);
		break;
	case Clusters::OtaSoftwareUpdateRequestor::Id:
		errorStatus = Clusters::OtaSoftwareUpdateRequestor::
			DispatchServerCommand(apCommandObj, aCommandPath,
					      aReader);
		break;
	case Clusters::ThreadNetworkDiagnostics::Id:
		errorStatus = Clusters::ThreadNetworkDiagnostics::
			DispatchServerCommand(apCommandObj, aCommandPath,
					      aReader);
		break;
	default:
